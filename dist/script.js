...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.accordion = function (headActive = 'accordion-head__active', contentActive = 'accordion-content__active', paddings = 40) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.tab = function () {
  for (let i = 0; i < this.length; i++) {
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).click(() => {
      Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).addClass('tab-item__active').siblings().removeClass('tab-item__active').closest('.tab').find('.tab-content').removeClass('tab-content__active').eq(Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).index()).addClass('tab-content__active');
    });
  }
};
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.addAttr = function (attrName, attrVal) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.remAttr = function (attrName) {
  for (let i = 0; i < this.length; i++) {
    if (!this[i].getAttribute(attrName)) {
      continue;
    }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.refreshAttr = function (attrName, attrVal) {
  for (let i = 0; i < this.length; i++) {
    if (this[i].getAttribute(attrName)) {
      this[i].setAttribute(attrName, attrVal);
    } else {
